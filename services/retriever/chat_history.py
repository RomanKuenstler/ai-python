...
class ChatHistoryService:
    ...
    def fetch(self, session_id: str, exclude_message_id: int | None = None) -> list[tuple[str, str]]:
        history = self.postgres_client.get_recent_chat_history(session_id, self.history_limit)
