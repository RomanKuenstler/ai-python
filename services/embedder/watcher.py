...
class PollingWatcher:
    def __init__(self, *, data_dir: Path, interval_seconds: int, processor: FileProcessor) -> None:
    ...
    def sync_once(self) -> None:
        ...
        for relative_path, absolute_path in disk_files.items():
            ...
            if tracked is None or tracked.file_hash != file_hash:
                LOGGER.info("Detected file change", extra={"file_path": relative_path})
